...
public class ManipularArquivo {
    ...
    public ManipularArquivo(String arquivoUsuario, SistmUsuario sistema){
    ...
    public void carregarDadosUsuario() { // le o arquivo csv ja existente e carrega o que tem nele para as variaveis do programa
        try (BufferedReader maca = new BufferedReader(new FileReader(arquivoUsuario))) {
            ...
            while ((linha = maca.readLine()) != null) {
                ...
                //checa se foram apenas 3 variaveis, se sim, setta data de validade como null, indicando prod nao perecivel
